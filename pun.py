# SinglCMD - Auto Punch Module (ساختار دقیقاً مشابه zed2.py)
import babase
...
# ============================================
# کلاس کمکی UI (دقیقاً مثل SC در zed2.py)
# ============================================
class UI:
    @classmethod
    def UIS(cls):
...
# ============================================
# ذخیره تنظیمات (مثل var در zed2.py)
# ============================================
pr = 'ap_'
...
# ============================================
# منوی تنظیمات Auto Punch (دقیقاً مثل منوهای zed2.py)
# ============================================
class AutoPunchMenu:
    def __init__(self, source):
        ...
        tw(
            parent=w,
            text=f'📏 Range: {current_range:.1f} meters',
            scale=0.9,
            position=(160, 280),
            h_align='center',
            color=(0.8, 1, 0.8)
    ...
    def _test_punch(self):
        ...
        if my_spaz:
            my_spaz.punch()
            push('🔴 Test punch!', color=(1, 0.5, 0))
        else:
            UI.err('⚠️ No spaz found! Are you in a game?')
...
# ============================================
# کلاس اصلی افزونه (دقیقاً مثل ساختار zed2.py)
# ============================================
class AutoPunchPlugin(babase.Plugin):
    ...
    def _patch_party_window(self):
        """اضافه کردن دکمه به صفحه چت - دقیقاً مثل zed2.py"""
        original_init = party.PartyWindow.__init__
        
        def patched_init(self, *a, **k):
            r = original_init(self, *a, **k)
            
            # دکمه Auto Punch - موقعیت پایین سمت راست
            btn = UI.bw(
                icon=gt('achievementCrossHair'),
                position=(self._width - 55, self._height - 460),
...
# ============================================
# ثبت کلاس اصلی (دقیقاً مثل zed2.py)
# ============================================
